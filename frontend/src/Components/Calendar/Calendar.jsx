...
const defaultEvents = [{
    ...
    id: 2,
    start: '2023-06-29T15:00',
    end: '2023-06-29T16:00',
    ...
    id: 3,
    start: '2023-06-28T18:00',
    end: '2023-06-28T22:00',
    title: 'Dexter BD',
    description: '',
    allDay: false,
    free: true,
    ...
    id: 4,
    start: '2023-06-30T10:30',
    end: '2023-06-30T11:30',
...
function ReactCalendar() {
    ...
    return <div>
        {/* <Taskbar/> */}
        <div style={{width:'90%',marginLeft:'7%',marginTop:'3%',height:'85vh'}}>
            <Eventcalendar
                view={viewSettings}
                data={myEvents}
